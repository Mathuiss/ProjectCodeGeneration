...
public class WithdrawApiController implements WithdrawApi {
    ...
    public WithdrawApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Void> withdrawPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Transaction body) {
