...
@Pattern(regexp="\\d{4}[A-Z]{2}")   public String getZipcode() {
    return zipcode;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, user.id) &&
        ...
        Objects.equals(this.appendix, user.appendix) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, email, hash, streetname, zipcode, addressnumber, appendix, phoneNumber, currentAccounts, savingsAccounts, isEmployee);
  }
